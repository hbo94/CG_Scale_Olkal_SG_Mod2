...
void setup(void)
{
  ...
  while (setupIsFinish != 1) {
    ...
    switch (numMenu) {
      ...
      case 5:
        //toOLED("Mettre la tare sur la", "balance avant", "Touche 'Enter 5s'", "pour lancer.");
        break;

      case 6:
        //toOLED("Mettre la tare sur la", "balance arriere", "Touche 'Enter 5s'", "pour lancer.");
        break;
    } // end of switch
  } // end of while
  ...
  toOLED("Configuration", "terminee.", "Prete pour peser", " un modele.");
  delay(2000);
...
void pressHandler(int key) {
  ...
  if (numMenu == 4 && key == 4) {
    toOLED("Nouveau poids", "de reference", str_weight, "");
    ...
    switch (key) {
      ...
      case 4: // Enter
        ...
        if (SF_front != SF_front_default) {
          ...
          toOLED("Calibration balance", "avant terminee.", "", "");
          calibFrontOK = 1;
    ...
    switch (key) {
      ...
      case 4: // Enter
        ...
        if (SF_back != SF_back_default) {
          ...
          toOLED("Calibration balance", "arriere terminee.", "", "");
          calibBackOK = 1;
...
void displayMenu(byte num, byte selectedItem) {
  char* menuItem10 = {"Configuration"};
  char* menuItem20 = {" Choix support"};
  char* menuItem30 = {" Calibration"};
  char* menuItem21 = {"Support : "};
  char* menuItem22 = {" Petit"};
  char* menuItem23 = {" Moyen"};
  char* menuItem24 = {" Grand"};
  char* menuItem31 = {" Config. tare"};
  char* menuItem32 = {" Calibration avant"};
  char* menuItem33 = {" Calibration arriere"};
  char* menuItem40 = {" Quitter"};
  char selected[20] = {""};
  char support[20] = {""};
  char selector[] = {'>'};
  char* r1;
