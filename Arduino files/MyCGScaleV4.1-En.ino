...
void displayMenu(byte num, byte selectedItem) {
  ...
  char* menuItem20 = {" Support option"};
  char* menuItem30 = {" Calibration"};
  char* menuItem21 = {"Support : "};
  char* menuItem22 = {" Small"};
  char* menuItem23 = {" Medium"};
  char* menuItem24 = {" Large"};
  char* menuItem31 = {" Tare config."};
  char* menuItem32 = {" Front calibration"};
  char* menuItem33 = {" Back calibration"};
  char* menuItem40 = {" Quit"};
  char selected[20] = {""};
  char support[20] = {""};
  char selector[] = {'>'};
  char* r1;
